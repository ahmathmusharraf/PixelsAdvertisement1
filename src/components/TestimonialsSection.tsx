...
export const TestimonialsSection: React.FC = () => {
  ...
  const brandPages = [
    [
      { name: 'China Harbour', desc: 'Engineering Company' },
      { name: 'Empire Real Estate', desc: 'Developments LLC - Dubai' },
      { name: 'Eureka Restaurant', desc: '& Cafe LLC' },
      { name: 'MOHRE', desc: 'Ministry of Human Resources' },
      { name: 'Emirates', desc: 'Group of Companies' },
      { name: 'LuLu Group', desc: 'Hypermarkets & Retail' },
    ],
    [
      { name: 'ADCB', desc: 'Commercial Banking' },
      { name: 'NESTO', desc: 'Retail Group' },
      { name: 'Ajman Bank', desc: 'Financial Services' },
      { name: 'Ramada', desc: 'Hospitality & Resorts' },
      { name: 'RAK Bank', desc: 'Banking Group' },
    ...
    [
      ...
      { name: 'Aster', desc: 'Healthcare Group' },
      { name: 'Gulf Craft', desc: 'Luxury Marine' },
      { name: 'Danube', desc: 'Building Materials' },
    ],
    [
      { name: 'Landmark', desc: 'Retail & Fashion' },
      { name: 'Sharaf DG', desc: 'Electronics & Tech' },
      { name: 'Al Zorah', desc: 'Real Estate Dev.' },
      { name: 'Sharjah Co-Op', desc: 'Retail Cooperative' },
      { name: 'Thumbay Group', desc: 'Healthcare & Edu' },
      { name: 'Red Crescent', desc: 'Government & NGO' },
    ],
  ];
  ...
  const testimonials = [
    {
      id: 1,
      quote:
        'Pixels Advertisement provided high-precision outdoor project hoardings and site safety signages for China Harbour Engineering Company. Exceptional durability and fast turnaround!',
      name: 'Project Director',
      role: 'China Harbour Engineering Company',
      rating: 5,
    ...
    },
    {
      id: 2,
      quote:
        'Stunning 3D illuminated letters, push-thru reception signs, and luxury sales suite branding for our Dubai development projects. Highly reliable team!',
      name: 'Operations Head',
      role: 'Empire Real Estate Developments LLC - Dubai',
      rating: 5,
    ...
    },
    {
      id: 3,
      quote:
        'Vibrant custom neon flex signs, backlit acrylic fascia boards, and window graphics for Eureka Cafe. They transformed our restaurant aesthetic completely.',
      name: 'Managing Partner',
      role: 'Eureka Restaurant & Cafe LLC',
      rating: 5,
    ...
    },
    {
      id: 4,
      quote:
        'Official compliant wayfinding signages, municipal safety displays, and high-definition indoor LED screens installed with total precision.',
      name: 'Facilities Lead',
      role: 'MOHRE (Ministry of Human Resources)',
      rating: 5,
    ...
    },
    {
      id: 5,
      quote:
        'From concept designs to final LED mounting, Pixels delivered top-tier branding assets for our group of companies across the UAE.',
      name: 'Fatima Al Hashimi',
      role: 'Group of Companies',
      rating: 5,
